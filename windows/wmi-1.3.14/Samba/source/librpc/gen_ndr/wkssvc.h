...
struct wkssvc_NetWkstaInfo101 {
	...
	uint32_t version_major;
	uint32_t version_minor;
	const char *lan_root;/* [charset(UTF16),unique,string] */
};
...
struct wkssvc_NetWkstaInfo102 {
	...
	uint32_t version_major;
	uint32_t version_minor;
	const char *lan_root;/* [unique,charset(UTF16),string] */
...
struct USER_INFO_1 {
	const char *user_name;/* [string,unique,charset(UTF16)] */
	const char *logon_domain;/* [charset(UTF16),unique,string] */
	const char *other_domains;/* [unique,charset(UTF16),string] */
	const char *logon_server;/* [charset(UTF16),unique,string] */
};
...
union WKS_USER_ENUM_UNION {
	struct USER_INFO_0_CONTAINER *user0;/* [case(0),unique] */
	struct USER_INFO_1_CONTAINER *user1;/* [case,unique] */
}/* [switch_type(uint32)] */;
...
struct wkssvc_NetWkstaTransportInfo0 {
	...
	const char *address;/* [string,charset(UTF16),unique] */
	uint32_t wan_link;
};
...
struct wkssvc_NetWkstaTransportEnum {
	struct {
		const char *server_name;/* [string,unique,charset(UTF16)] */
		uint32_t level;
		union wkssvc_NetWkstaTransportCtr *ctr;/* [switch_is(level),ref] */
		uint32_t max_buffer;
...
struct wkssvc_NetrJoinDomain2 {
	struct {
		const char *server_name;/* [unique,charset(UTF16),string] */
		const char *domain_name;/* [charset(UTF16),string,ref] */
		const char *account_name;/* [unique,charset(UTF16),string] */
		const char *admin_account;/* [unique,charset(UTF16),string] */
...
struct wkssvc_NetrUnjoinDomain2 {
	struct {
		...
		const char *account;/* [string,charset(UTF16),unique] */
		struct wkssvc_PasswordBuffer *encrypted_password;/* [unique] */
...
struct wkssvc_NetrRenameMachineInDomain2 {
	struct {
		const char *server_name;/* [string,charset(UTF16),unique] */
		const char *NewMachineName;/* [charset(UTF16),unique,string] */
		const char *Account;/* [string,charset(UTF16),unique] */
...
struct wkssvc_NetrAddAlternateComputerName {
	struct {
		const char *server_name;/* [unique,charset(UTF16),string] */
		const char *NewAlternateMachineName;/* [string,charset(UTF16),unique] */
		const char *Account;/* [string,unique,charset(UTF16)] */
		struct wkssvc_PasswordBuffer *EncryptedPassword;/* [unique] */
		uint32_t Reserved;
	} in;
...
struct wkssvc_NetrRemoveAlternateComputerName {
	struct {
		const char *server_name;/* [string,charset(UTF16),unique] */
		const char *AlternateMachineNameToRemove;/* [charset(UTF16),unique,string] */
		const char *Account;/* [string,charset(UTF16),unique] */
		struct wkssvc_PasswordBuffer *EncryptedPassword;/* [unique] */
		uint32_t Reserved;
	} in;
