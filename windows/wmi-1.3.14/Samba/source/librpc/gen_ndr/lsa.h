...
struct lsa_ObjectAttribute {
	...
	const char *object_name;/* [string,unique,charset(UTF16)] */
	uint32_t attributes;
...
struct lsa_QueryInfoPolicy {
	...
	struct {
		union lsa_PolicyInformation *info;/* [switch_is(level),unique] */
		NTSTATUS result;
	} out;
...
struct lsa_OpenPolicy2 {
	struct {
		const char *system_name;/* [string,charset(UTF16),unique] */
		struct lsa_ObjectAttribute *attr;/* [ref] */
		uint32_t access_mask;
	} in;
...
struct lsa_GetUserName {
	struct {
		const char *system_name;/* [charset(UTF16),unique,string] */
