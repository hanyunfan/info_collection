...
struct CreateInstance {
	...
	struct {
		struct ORPCTHAT *ORPCthat;/* [ref] */
		struct MInterfacePointer **ppv;/* [iid_is(riid),ref] */
		WERROR result;
	} out;
...
struct RemQueryInterface {
	...
	struct {
		struct ORPCTHAT *ORPCthat;/* [ref] */
		struct REMQIRESULT **rqir;/* [size_is(,cIids),ref] */
		WERROR result;
	} out;
...
struct RemAddRef {
	...
	struct {
		struct ORPCTHAT *ORPCthat;/* [ref] */
		WERROR **pResults;/* [size_is(cInterfaceRefs),ref] */
		WERROR result;
	} out;
...
struct RemQueryInterface2 {
	struct {
		...
		uint16_t cIids;
		struct GUID **iids;/* [size_is(cIids),ref] */
	} in;
...
struct MakeCoffee {
	struct {
		struct ORPCTHIS ORPCthis;
		const char *flavor;/* [charset(UTF16),string,ref] */
	} in;
...
struct Delete {
	struct {
		struct ORPCTHIS ORPCthis;
		const char *wszName;/* [ref,charset(UTF16),string] */
	} in;
...
struct arr_CIMSTRING {
	uint32_t count;
	CIMSTRING *item;/* [string,relative,charset(UTF16)] */
}/* [public] */;

struct arr_WbemClassObject {
	uint32_t count;
	struct WbemClassObject **item;/* [subcontext(4),relative] */
}/* [public] */;
...
union CIMVAR {
	...
	CIMSTRING v_string;/* [charset(UTF16),case(CIM_STRING),string,relative] */
	CIMSTRING v_datetime;/* [charset(UTF16),relative,case(CIM_DATETIME),string] */
	CIMSTRING v_reference;/* [string,case(CIM_REFERENCE),relative,charset(UTF16)] */
	struct WbemClassObject *v_object;/* [case(CIM_OBJECT),subcontext(4),relative] */
	...
	struct arr_int32 *a_sint32;/* [case(CIM_ARR_SINT32),relative] */
	...
	struct arr_udlong *a_real64;/* [case(CIM_ARR_REAL64),relative] */
	struct arr_uint16 *a_boolean;/* [case(CIM_ARR_BOOLEAN),relative] */
	struct arr_CIMSTRING *a_string;/* [relative,case(CIM_ARR_STRING)] */
	struct arr_CIMSTRING *a_datetime;/* [case(CIM_ARR_DATETIME),relative] */
...
struct WbemQualifier {
	CIMSTRING name;/* [string,relative,charset(UTF16)] */
	uint8_t flavors;
...
struct CIMSTRINGS {
	uint32_t count;
	CIMSTRING *item;/* [ref,charset(UTF16),string] */
}/* [public,nopull,nopush] */;
...
struct WbemClass {
	uint8_t u_0;
	CIMSTRING __CLASS;/* [charset(UTF16),relative,string,null_is_ffffffff] */
	uint32_t data_size;
...
}/* [nopush,nopull,flag(LIBNDR_FLAG_NOALIGN),public,noprint] */;

struct WbemMethod {
	CIMSTRING name;/* [null_is_ffffffff,charset(UTF16),relative,string] */
	uint32_t u0;
	uint32_t u1;
	struct WbemQualifiers *qualifiers;/* [relative] */
	struct WbemClassObject *in;/* [subcontext(4),relative] */
...
struct WbemInstance {
	uint8_t u1_0;
	CIMSTRING __CLASS;/* [string,relative,charset(UTF16)] */
	uint8_t *default_flags;/* [unique] */
	union CIMVAR *data;/* [unique] */
	uint32_t u2_4;
	uint8_t u3_1;
}/* [flag(LIBNDR_FLAG_NOALIGN),noprint,public,nopull,nopush] */;

struct WbemClassObject {
	uint8_t flags;
	CIMSTRING __SERVER;/* [string,charset(UTF16),ref] */
...
}/* [noprint,public,flag(LIBNDR_FLAG_NOALIGN),nopush,nopull] */;
...
struct CreateInstanceEnum {
	struct {
		struct ORPCTHIS ORPCthis;
		BSTR strFilter;/* [ref,charset(UTF16),string] */
		int32_t lFlags;
		struct MInterfacePointer *pCtx;/* [unique] */
	} in;
...
struct ExecQuery {
	struct {
		struct ORPCTHIS ORPCthis;
		BSTR strQueryLanguage;/* [ref,charset(UTF16),string] */
		BSTR strQuery;/* [string,charset(UTF16),ref] */
		int32_t lFlags;
		struct MInterfacePointer *pCtx;/* [unique] */
	} in;
...
struct ExecMethod {
	struct {
		struct ORPCTHIS ORPCthis;
		BSTR strObjectPath;/* [charset(UTF16),string,ref] */
		BSTR strMethodName;/* [string,charset(UTF16),ref] */
		int32_t lFlags;
		struct MInterfacePointer *pCtx;/* [unique] */
...
struct NTLMLogin {
	struct {
		struct ORPCTHIS ORPCthis;
		const char *wszNetworkResource;/* [string,unique,charset(UTF16)] */
		const char *wszPreferredLocale;/* [string,unique,charset(UTF16)] */
		int32_t lFlags;
		struct MInterfacePointer *pCtx;/* [unique] */
	} in;
