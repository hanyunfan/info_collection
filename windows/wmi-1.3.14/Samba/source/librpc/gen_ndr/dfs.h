...
struct dfs_StorageInfo {
	uint32_t state;
	const char *server;/* [charset(UTF16),unique,string] */
	const char *share;/* [string,charset(UTF16),unique] */
};

struct dfs_Info3 {
	const char *path;/* [charset(UTF16),unique,string] */
...
struct dfs_Info6 {
	const char *entry_path;/* [string,charset(UTF16),unique] */
...
struct dfs_Info200 {
	const char *dom_root;/* [charset(UTF16),unique,string] */
};
...
struct dfs_Info300 {
	...
	const char *dom_root;/* [unique,charset(UTF16),string] */
};
...
struct dfs_Add {
	struct {
		const char *path;/* [string,charset(UTF16),ref] */
		const char *server;/* [charset(UTF16),string,ref] */
		const char *share;/* [string,charset(UTF16),unique] */
		const char *comment;/* [string,charset(UTF16),unique] */
		uint32_t flags;
	} in;
...
struct dfs_Remove {
	struct {
		const char *dfs_entry_path;/* [charset(UTF16),string,ref] */
		const char *servername;/* [unique,charset(UTF16),string] */
		const char *sharename;/* [charset(UTF16),unique,string] */
	} in;
...
struct dfs_SetInfo {
	struct {
		...
		const char *servername;/* [charset(UTF16),unique,string] */
		const char *sharename;/* [string,unique,charset(UTF16)] */
		uint32_t level;
...
struct dfs_GetInfo {
	struct {
		const char *dfs_entry_path;/* [string,charset(UTF16)] */
		const char *servername;/* [string,charset(UTF16),unique] */
		const char *sharename;/* [string,charset(UTF16),unique] */
		uint32_t level;
	} in;
...
struct dfs_AddFtRoot {
	struct {
		const char *servername;/* [charset(UTF16),string] */
		const char *dns_servername;/* [charset(UTF16),string] */
		const char *dfsname;/* [charset(UTF16),string] */
		const char *rootshare;/* [string,charset(UTF16)] */
		const char *comment;/* [charset(UTF16),string] */
...
struct dfs_RemoveFtRoot {
	struct {
		...
		const char *dns_servername;/* [charset(UTF16),string] */
		const char *dfsname;/* [charset(UTF16),string] */
		const char *rootshare;/* [charset(UTF16),string] */
		uint32_t flags;
...
struct dfs_ManagerInitialize {
	struct {
		const char *servername;/* [string,charset(UTF16),ref] */
		uint32_t flags;
	} in;
...
struct dfs_AddStdRootForced {
	struct {
		...
		const char *rootshare;/* [string,charset(UTF16)] */
		const char *comment;/* [charset(UTF16),string] */
		const char *store;/* [charset(UTF16),string] */
	} in;
...
struct dfs_EnumEx {
	struct {
		const char *dfs_name;/* [charset(UTF16),string] */
		uint32_t level;
		uint32_t bufsize;
		struct dfs_EnumStruct *info;/* [unique] */
		uint32_t *total;/* [unique] */
