...
struct srvsvc_NetCharDevInfo0 {
	const char *device;/* [string,charset(UTF16),unique] */
};
...
struct srvsvc_NetCharDevInfo1 {
	const char *device;/* [string,unique,charset(UTF16)] */
	uint32_t status;
...
struct srvsvc_NetCharDevQInfo0 {
	const char *device;/* [charset(UTF16),unique,string] */
};
...
struct srvsvc_NetCharDevQInfo1 {
	const char *device;/* [charset(UTF16),unique,string] */
	uint32_t priority;
	const char *devices;/* [string,charset(UTF16),unique] */
	uint32_t users;
	uint32_t num_ahead;
};
...
struct srvsvc_NetConnInfo1 {
	...
	uint32_t conn_time;
	const char *user;/* [string,unique,charset(UTF16)] */
	const char *share;/* [string,unique,charset(UTF16)] */
};
...
struct srvsvc_NetFileInfo3 {
	...
	uint32_t num_locks;
	const char *path;/* [unique,charset(UTF16),string] */
	const char *user;/* [charset(UTF16),unique,string] */
};
...
struct srvsvc_NetSessInfo0 {
	const char *client;/* [string,charset(UTF16),unique] */
};
...
struct srvsvc_NetSessInfo2 {
	const char *client;/* [string,unique,charset(UTF16)] */
	const char *user;/* [charset(UTF16),unique,string] */
	uint32_t num_open;
	uint32_t time;
	uint32_t idle_time;
	uint32_t user_flags;
	const char *client_type;/* [string,charset(UTF16),unique] */
};
...
struct srvsvc_NetSessInfo502 {
	...
	uint32_t user_flags;
	const char *client_type;/* [string,charset(UTF16),unique] */
	const char *transport;/* [string,unique,charset(UTF16)] */
};
...
struct srvsvc_NetShareInfo0 {
	const char *name;/* [unique,charset(UTF16),string] */
};

struct srvsvc_NetShareInfo1 {
	const char *name;/* [unique,charset(UTF16),string] */
	enum srvsvc_ShareType type;
	const char *comment;/* [unique,charset(UTF16),string] */
};

struct srvsvc_NetShareInfo2 {
	const char *name;/* [charset(UTF16),unique,string] */
	enum srvsvc_ShareType type;
	const char *comment;/* [unique,charset(UTF16),string] */
	uint32_t permissions;
	uint32_t max_users;
	uint32_t current_users;
	const char *path;/* [string,charset(UTF16),unique] */
	const char *password;/* [string,unique,charset(UTF16)] */
};

struct srvsvc_NetShareInfo501 {
	const char *name;/* [string,charset(UTF16),unique] */
	enum srvsvc_ShareType type;
	const char *comment;/* [unique,charset(UTF16),string] */
	uint32_t csc_policy;
};
...
struct srvsvc_NetShareInfo502 {
	const char *name;/* [unique,charset(UTF16),string] */
	enum srvsvc_ShareType type;
	const char *comment;/* [string,charset(UTF16),unique] */
	uint32_t permissions;
	int32_t max_users;
	uint32_t current_users;
	const char *path;/* [unique,charset(UTF16),string] */
...
struct srvsvc_NetShareInfo1004 {
	const char *comment;/* [charset(UTF16),unique,string] */
};
...
struct srvsvc_NetShareInfo1007 {
	uint32_t flags;
	const char *alternate_directory_name;/* [string,unique,charset(UTF16)] */
};
...
struct srvsvc_NetSrvInfo100 {
	...
	const char *server_name;/* [string,charset(UTF16),unique] */
};
...
struct srvsvc_NetSrvInfo101 {
	...
	const char *comment;/* [string,unique,charset(UTF16)] */
};

struct srvsvc_NetSrvInfo102 {
	enum srvsvc_PlatformId platform_id;
	const char *server_name;/* [charset(UTF16),unique,string] */
	uint32_t version_major;
	uint32_t version_minor;
	uint32_t server_type;
	const char *comment;/* [string,charset(UTF16),unique] */
	...
	uint32_t anndelta;
	uint32_t licenses;
	const char *userpath;/* [unique,charset(UTF16),string] */
};
...
struct srvsvc_NetSrvInfo402 {
	...
	const char *alerts;/* [unique,charset(UTF16),string] */
	uint32_t security;
	uint32_t numadmin;
	uint32_t lanmask;
	const char *guestaccount;/* [unique,charset(UTF16),string] */
	uint32_t chdevs;
	uint32_t chdevqs;
	uint32_t chdevjobs;
	...
	uint32_t netioalert;
	uint32_t maxaudits;
	const char *srvheuristics;/* [string,charset(UTF16),unique] */
};
...
struct srvsvc_NetSrvInfo403 {
	...
	uint32_t glist_mtime;
	uint32_t alist_mtime;
	const char *alerts;/* [string,unique,charset(UTF16)] */
	uint32_t security;
	uint32_t numadmin;
	uint32_t lanmask;
	const char *guestaccount;/* [string,charset(UTF16),unique] */
	uint32_t chdevs;
	uint32_t chdevqs;
	uint32_t chdevjobs;
	uint32_t connections;
	...
	const char *autopath;/* [string,unique,charset(UTF16)] */
};
...
struct srvsvc_NetSrvInfo599 {
	...
	uint32_t acceptdownlevelapis;
	uint32_t lmannounce;
	const char *domain;/* [string,charset(UTF16),unique] */
	uint32_t maxcopyreadlen;
	uint32_t maxcopywritelen;
	uint32_t minkeepsearch;
	uint32_t minkeepcomplsearch;
...
struct srvsvc_NetTransportInfo0 {
	...
	uint32_t addr_len;
	const char *net_addr;/* [string,charset(UTF16),unique] */
};
...
struct srvsvc_NetTransportInfo1 {
	uint32_t vcs;
	const char *name;/* [string,unique,charset(UTF16)] */
	uint8_t *addr;/* [size_is(addr_len),unique] */
	uint32_t addr_len;
	const char *net_addr;/* [charset(UTF16),unique,string] */
	const char *domain;/* [string,charset(UTF16),unique] */
};
...
struct srvsvc_NetTransportInfo2 {
	...
	uint32_t addr_len;
	const char *net_addr;/* [charset(UTF16),unique,string] */
	const char *domain;/* [unique,charset(UTF16),string] */
	uint32_t unknown;
};
...
struct srvsvc_NetTransportInfo3 {
	...
	uint8_t *addr;/* [unique,size_is(addr_len)] */
	uint32_t addr_len;
	const char *net_addr;/* [unique,charset(UTF16),string] */
	const char *domain;/* [unique,charset(UTF16),string] */
	uint32_t unknown1;
	uint32_t unknown2;
...
struct srvsvc_NetCharDevEnum {
	struct {
		const char *server_unc;/* [unique,charset(UTF16),string] */
		uint32_t level;
...
struct srvsvc_NetCharDevQEnum {
	struct {
		...
		const char *user;/* [unique,charset(UTF16),string] */
		uint32_t level;
...
struct srvsvc_NetCharDevQGetInfo {
	struct {
		const char *server_unc;/* [unique,charset(UTF16),string] */
		const char *queue_name;/* [charset(UTF16),string] */
...
struct srvsvc_NetCharDevQPurge {
	struct {
		const char *server_unc;/* [string,charset(UTF16),unique] */
		const char *queue_name;/* [string,charset(UTF16)] */
	} in;
...
struct srvsvc_NetConnEnum {
	struct {
		const char *server_unc;/* [unique,charset(UTF16),string] */
		const char *path;/* [string,unique,charset(UTF16)] */
		uint32_t level;
...
struct srvsvc_NetShareSetInfo {
	struct {
		const char *server_unc;/* [string,charset(UTF16),unique] */
		const char *share_name;/* [charset(UTF16),string] */
		uint32_t level;
		union srvsvc_NetShareInfo info;/* [switch_is(level)] */
		uint32_t *parm_error;/* [unique] */
	} in;
...
struct srvsvc_NetShareCheck {
	struct {
		const char *server_unc;/* [string,unique,charset(UTF16)] */
		const char *device_name;/* [charset(UTF16),string] */
	} in;
...
struct srvsvc_NetServerStatisticsGet {
	struct {
		const char *server_unc;/* [string,unique,charset(UTF16)] */
		const char *service;/* [unique,charset(UTF16),string] */
		uint32_t level;
		uint32_t options;
	} in;
...
struct srvsvc_NetPathCompare {
	struct {
		const char *server_unc;/* [string,unique,charset(UTF16)] */
		const char *path1;/* [charset(UTF16),string] */
...
struct srvsvc_NetPRNameCompare {
	struct {
		const char *server_unc;/* [string,charset(UTF16),unique] */
		const char *name1;/* [charset(UTF16),string] */
...
struct srvsvc_NetServerSetServiceBitsEx {
	struct {
		const char *server_unc;/* [string,charset(UTF16),unique] */
		const char *emulated_server_unc;/* [unique,charset(UTF16),string] */
		const char *transport;/* [unique,charset(UTF16),string] */
