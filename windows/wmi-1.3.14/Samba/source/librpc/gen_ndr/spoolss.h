...
struct spoolss_PrinterInfo0 {
	...
	const char * servername;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	uint32_t cjobs;
	uint32_t total_jobs;
...
struct spoolss_PrinterInfo1 {
	uint32_t flags;
	const char * name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * description;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
...
struct spoolss_PrinterInfo2 {
	const char * servername;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * printername;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * sharename;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * portname;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * drivername;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char * comment;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char * location;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	struct spoolss_DeviceMode *devmode;/* [subcontext(0),relative] */
	const char * sepfile;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
...
struct spoolss_PrinterInfo3 {
	struct security_descriptor *secdesc;/* [subcontext(0),relative] */
};
...
}/* [public,nodiscriminant,relative_base] */;
...
struct spoolss_JobInfo1 {
	uint32_t job_id;
	const char * printer_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * server_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
...
}/* [nodiscriminant,relative_base,public] */;
...
union spoolss_SetPrinterInfo {
	struct spoolss_PrinterInfo0 *info0;/* [case(0),unique] */
	struct spoolss_PrinterInfo1 *info1;/* [unique,case] */
	struct spoolss_PrinterInfo2 *info2;/* [case(2),unique] */
	...
	struct spoolss_DeviceModeInfo *info9;/* [case(9),unique] */
}/* [switch_type(uint32)] */;
...
struct spoolss_DriverInfo2 {
	...
	const char * driver_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * architecture;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
...
struct spoolss_DriverInfo3 {
	...
	const char * driver_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * architecture;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * driver_path;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * data_file;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * config_file;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char * help_file;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char ** dependent_files;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
...
struct spoolss_DriverInfo4 {
	...
	const char * driver_path;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * data_file;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * config_file;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * help_file;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char ** dependent_files;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * monitor_name;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char * default_datatype;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
...
struct spoolss_DriverInfo6 {
	...
	const char * help_file;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char ** dependent_files;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * monitor_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * default_datatype;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char ** previous_names;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	NTTIME driver_data;
	uint64_t driver_version;
	const char * manufacturer_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * manufacturer_url;/* [relative,flag(LIBNDR_FLAG_STR_NULLTERM)] */
	const char * hardware_id;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * provider;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
};
...
}/* [public,relative_base,nodiscriminant] */;
...
}/* [public,gensize,relative_base,nodiscriminant] */;

struct spoolss_PrintProcessorInfo1 {
	const char * print_processor_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
};
...
struct spoolss_DocumentInfo1 {
	const char *document_name;/* [string,charset(UTF16),unique] */
	const char *output_file;/* [charset(UTF16),unique,string] */
	const char *datatype;/* [charset(UTF16),unique,string] */
};
...
struct spoolss_OSVersion {
	...
	const char * extra_string;/* [subcontext(0),flag(LIBNDR_FLAG_STR_NULLTERM),subcontext_size(256)] */
}/* [gensize,public] */;
...
}/* [relative_base,nodiscriminant,public,gensize] */;

struct spoolss_AddFormInfo1 {
	enum spoolss_FormFlags flags;
	const char *form_name;/* [string,unique,charset(UTF16)] */
	struct spoolss_FormSize size;
	struct spoolss_FormArea area;
};
...
struct spoolss_PortInfo2 {
	const char * port_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
	const char * monitor_name;/* [flag(LIBNDR_FLAG_STR_NULLTERM),relative] */
...
struct spoolss_RemoteFindFirstPrinterChangeNotifyEx_t1 {
	...
	uint32_t u2;
	uint32_t count;
	struct spoolss_RemoteFindFirstPrinterChangeNotifyEx_t2 *t2;/* [size_is(count),unique] */
};

struct spoolss_UserLevel1 {
	uint32_t size;
	const char *client;/* [charset(UTF16),unique,string] */
	const char *user;/* [string,unique,charset(UTF16)] */
	uint32_t build;
	uint32_t major;
	uint32_t minor;
	uint32_t processor;
...
struct _spoolss_EnumPrinters {
	struct {
		uint32_t flags;
		const char *server;/* [unique,charset(UTF16),string] */
		uint32_t level;
...
struct spoolss_EnumPrinters {
	struct {
		uint32_t flags;
		const char *server;/* [string,unique,charset(UTF16)] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
	} in;
	...
	struct {
		union spoolss_PrinterInfo *info;/* [size_is(count),unique,switch_is(level)] */
		uint32_t needed;
		uint32_t count;
		WERROR result;
	} out;
...
struct spoolss_OpenPrinter {
	struct {
		const char *printername;/* [unique,charset(UTF16),string] */
		const char *datatype;/* [charset(UTF16),unique,string] */
...
struct spoolss_EnumJobs {
	...
	struct {
		union spoolss_JobInfo *info;/* [size_is(count),unique,switch_is(level)] */
		uint32_t needed;
		uint32_t count;
		WERROR result;
	} out;
...
struct spoolss_GetPrinter {
	...
	struct {
		union spoolss_PrinterInfo *info;/* [unique,subcontext(4),switch_is(level),subcontext_size(offered)] */
		uint32_t needed;
		WERROR result;
	} out;
...
struct _spoolss_EnumPrinterDrivers {
	struct {
		const char *server;/* [unique,charset(UTF16),string] */
		const char *environment;/* [unique,charset(UTF16),string] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
	} in;
...
struct spoolss_EnumPrinterDrivers {
	struct {
		const char *server;/* [unique,charset(UTF16),string] */
		const char *environment;/* [charset(UTF16),unique,string] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
	} in;
	...
	struct {
		union spoolss_DriverInfo *info;/* [unique,size_is(count),switch_is(level)] */
		uint32_t needed;
		uint32_t count;
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverDirectory {
	struct {
		const char *server;/* [string,charset(UTF16),unique] */
		const char *environment;/* [string,unique,charset(UTF16)] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
	} in;
...
struct _spoolss_EnumPrintProcessors {
	struct {
		const char *servername;/* [string,unique,charset(UTF16)] */
		const char *environment;/* [string,unique,charset(UTF16)] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
...
struct spoolss_EnumPrintProcessors {
	...
	struct {
		union spoolss_PrintProcessorInfo *info;/* [size_is(count),unique,switch_is(level)] */
		uint32_t needed;
		uint32_t count;
		WERROR result;
	} out;
...
struct _spoolss_GetPrinterData {
	struct {
		struct policy_handle *handle;/* [ref] */
		const char *value_name;/* [charset(UTF16),string] */
		uint32_t offered;
	} in;
...
struct spoolss_GetPrinterData {
	...
	struct {
		enum spoolss_PrinterDataType type;
		union spoolss_PrinterData data;/* [subcontext(4),switch_is(type),subcontext_size(offered)] */
		uint32_t needed;
		WERROR result;
	} out;
...
struct spoolss_SetPrinterData {
	struct {
		...
		const char *value_name;/* [charset(UTF16),string] */
		enum spoolss_PrinterDataType type;
		union spoolss_PrinterData data;/* [switch_is(type),subcontext(4)] */
...
struct spoolss_GetForm {
	struct {
		struct policy_handle *handle;/* [ref] */
		const char *form_name;/* [charset(UTF16),string] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
	} in;
...
struct spoolss_EnumForms {
	...
	struct {
		union spoolss_FormInfo *info;/* [size_is(count),unique,switch_is(level)] */
		uint32_t needed;
		uint32_t count;
		WERROR result;
	} out;
...
struct spoolss_EnumPorts {
	...
	struct {
		union spoolss_PortInfo *info;/* [unique,size_is(count),switch_is(level)] */
		uint32_t needed;
		uint32_t count;
		WERROR result;
	} out;
...
struct _spoolss_EnumMonitors {
	struct {
		const char *servername;/* [unique,charset(UTF16),string] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
	} in;
...
struct spoolss_EnumMonitors {
	...
	struct {
		union spoolss_MonitorInfo *info;/* [switch_is(level),size_is(count),unique] */
		uint32_t needed;
		uint32_t count;
		WERROR result;
	} out;
...
struct spoolss_AddPort {
	struct {
		const char *server_name;/* [string,unique,charset(UTF16)] */
		uint32_t unknown;
		const char *monitor_name;/* [charset(UTF16),string] */
	} in;
...
struct spoolss_GetPrinterDriver2 {
	struct {
		struct policy_handle *handle;/* [ref] */
		const char *architecture;/* [unique,charset(UTF16),string] */
		uint32_t level;
		DATA_BLOB *buffer;/* [unique] */
		uint32_t offered;
...
struct spoolss_RemoteFindFirstPrinterChangeNotifyEx {
	struct {
		...
		uint32_t u1;
		uint32_t u2;
		const char *str;/* [unique,charset(UTF16),string] */
		uint32_t u3;
...
struct spoolss_OpenPrinterEx {
	struct {
		const char *printername;/* [unique,charset(UTF16),string] */
		const char *datatype;/* [string,unique,charset(UTF16)] */
		struct spoolss_DevmodeContainer devmode_ctr;
		uint32_t access_mask;
		uint32_t level;
...
struct spoolss_AddPrinterEx {
	struct {
		const char *server;/* [string,unique,charset(UTF16)] */
		uint32_t level;
		union spoolss_PrinterInfo *info;/* [switch_is(level),unique] */
		struct spoolss_DevmodeContainer devmode_ctr;
...
struct spoolss_GetPrinterDataEx {
	struct {
		struct policy_handle *handle;/* [ref] */
		const char *key_name;/* [charset(UTF16),string] */
		const char *value_name;/* [string,charset(UTF16)] */
		uint32_t offered;
	} in;
