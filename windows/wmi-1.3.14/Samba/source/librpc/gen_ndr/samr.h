...
struct samr_RidTypeArray {
	...
	uint32_t *types;/* [size_is(count),unique] */
};
...
struct samr_QueryGroupInfo {
	...
	struct {
		union samr_GroupInfo *info;/* [switch_is(level),unique] */
		NTSTATUS result;
	} out;
...
struct samr_QueryAliasInfo {
	...
	struct {
		union samr_AliasInfo *info;/* [switch_is(level),unique] */
		NTSTATUS result;
	} out;
...
struct samr_QueryDomainInfo2 {
	...
	struct {
		union samr_DomainInfo *info;/* [switch_is(level),unique] */
		NTSTATUS result;
	} out;
...
struct samr_QueryUserInfo2 {
	...
	struct {
		union samr_UserInfo *info;/* [switch_is(level),unique] */
		NTSTATUS result;
	} out;
...
struct samr_Connect2 {
	struct {
		const char *system_name;/* [string,unique,charset(UTF16)] */
		uint32_t access_mask;
	} in;
...
struct samr_Connect5 {
	struct {
		...
		uint32_t access_mask;
		uint32_t level;
		union samr_ConnectInfo *info;/* [switch_is(level),ref] */
	} in;
