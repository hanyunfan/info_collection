...
struct drsuapi_DsReplicaSyncRequest1 {
	...
	struct GUID guid1;
	const char * string1;/* [flag(LIBNDR_FLAG_STR_ASCII|LIBNDR_FLAG_STR_NULLTERM),unique] */
	uint32_t options;
};
...
struct drsuapi_DsGetNCChangesRequest_Ctr14 {
	...
	uint8_t *byte_array;/* [size_is(length),unique] */
...
struct drsuapi_DsGetNCChangesRequest_Ctr12 {
	uint32_t count;/* [range(0,0x100000)] */
	struct drsuapi_DsGetNCChangesRequest_Ctr13 *array;/* [size_is(count),unique] */
};
...
struct drsuapi_DsAttributeValueCtrDataBlob {
	...
	struct drsuapi_DsAttributeValueDataBlob *values;/* [size_is(num_values),unique] */
};

struct drsuapi_DsAttributeValueObjectClassId {
	uint32_t __ndr_size;/* [range(0,10485760),value(4)] */
	enum drsuapi_DsObjectClassId *objectClassId;/* [unique,subcontext(4)] */
};

struct drsuapi_DsAttributeValueCtrObjectClassId {
	uint32_t num_values;/* [range(0,10485760)] */
	struct drsuapi_DsAttributeValueObjectClassId *values;/* [size_is(num_values),unique] */
};
...
struct drsuapi_DsAttributeValueUnicodeString {
	uint32_t length;/* [range(0,10485760)] */
	const char * string;/* [flag(LIBNDR_FLAG_STR_NULLTERM),unique,subcontext(4)] */
};

struct drsuapi_DsAttributeValueCtrUnicodeString {
	uint32_t num_values;/* [range(0,10485760)] */
	struct drsuapi_DsAttributeValueUnicodeString *values;/* [size_is(num_values),unique] */
};
...
struct drsuapi_DsAttributeValueDNString {
	...
	struct drsuapi_DsReplicaObjectIdentifier3 *object;/* [subcontext_size(__ndr_size),subcontext(4),unique] */
};
...
struct drsuapi_DsAttributeValueCtrGUID {
	uint32_t num_values;/* [range(0,10485760)] */
	struct drsuapi_DsAttributeValueGUID *values;/* [size_is(num_values),unique] */
};

struct drsuapi_DsAttributeValueSID {
	uint32_t __ndr_size;/* [value(ndr_size_dom_sid(sid,ndr->flags)),range(0,10485760)] */
	struct dom_sid *sid;/* [subcontext(4),unique] */
};

struct drsuapi_DsAttributeValueCtrSID {
	uint32_t num_values;/* [range(0,10485760)] */
	struct drsuapi_DsAttributeValueSID *values;/* [size_is(num_values),unique] */
};
...
struct drsuapi_DsAttributeValueNTTIME_1sec {
	uint32_t __ndr_size;/* [range(0,10485760),value(8)] */
	NTTIME *time;/* [subcontext(4),unique] */
};
...
struct drsuapi_DsGetNCChangesMSZIPCtr1 {
	...
	struct drsuapi_DsGetNCChangesCtr1 *ctr1;/* [subcontext(4),unique,compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),subcontext_size(r->compressed_length)] */
};

struct drsuapi_DsGetNCChangesMSZIPCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	struct drsuapi_DsGetNCChangesCtr6 *ctr6;/* [subcontext_size(r->compressed_length),compression(NDR_COMPRESSION_MSZIP,compressed_length,decompressed_length),unique,subcontext(4)] */
};

struct drsuapi_DsGetNCChangesXPRESSCtr1 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	DATA_BLOB *decompressed;/* [unique,subcontext(4),flag(LIBNDR_FLAG_REMAINING),subcontext_size(r->compressed_length),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length)] */
};

struct drsuapi_DsGetNCChangesXPRESSCtr6 {
	uint32_t decompressed_length;
	uint32_t compressed_length;
	DATA_BLOB *decompressed;/* [unique,subcontext(4),subcontext_size(r->compressed_length),flag(LIBNDR_FLAG_REMAINING),compression(NDR_COMPRESSION_XPRESS,compressed_length,decompressed_length)] */
};
...
struct drsuapi_DsNameInfo1 {
	...
	const char *dns_domain_name;/* [unique,charset(UTF16),string] */
	const char *result_name;/* [charset(UTF16),unique,string] */
};
...
struct drsuapi_DsWriteAccountSpnRequest1 {
	...
	uint32_t unknown1;
	const char *object_dn;/* [charset(UTF16),unique,string] */
...
struct drsuapi_DsRemoveDSServerRequest1 {
	const char *server_dn;/* [string,unique,charset(UTF16)] */
	const char *domain_dn;/* [string,charset(UTF16),unique] */
	uint32_t unknown;
};
...
struct drsuapi_DsGetDCInfoRequest1 {
	const char *domain_name;/* [unique,charset(UTF16),string] */
	int32_t level;
};
...
struct drsuapi_DsGetDCInfo1 {
	const char *netbios_name;/* [string,unique,charset(UTF16)] */
	const char *dns_name;/* [string,unique,charset(UTF16)] */
	const char *site_name;/* [charset(UTF16),unique,string] */
	const char *computer_dn;/* [string,unique,charset(UTF16)] */
	const char *server_dn;/* [string,charset(UTF16),unique] */
	uint32_t is_pdc;
	uint32_t is_enabled;
};
...
struct drsuapi_DsGetDCInfo2 {
	const char *netbios_name;/* [string,unique,charset(UTF16)] */
	const char *dns_name;/* [charset(UTF16),unique,string] */
	const char *site_name;/* [charset(UTF16),unique,string] */
	const char *site_dn;/* [charset(UTF16),unique,string] */
	const char *computer_dn;/* [string,unique,charset(UTF16)] */
	const char *server_dn;/* [unique,charset(UTF16),string] */
	const char *ntds_dn;/* [charset(UTF16),unique,string] */
	uint32_t is_pdc;
	uint32_t is_enabled;
	uint32_t is_gc;
	struct GUID site_guid;
...
struct drsuapi_DsGetDCInfo01 {
	...
	uint32_t unknown5;
	uint32_t unknown6;
	const char *server_nt4_account;/* [string,unique,charset(UTF16)] */
};

struct drsuapi_DsGetDCInfoCtr01 {
	uint32_t count;/* [range(0,10000)] */
	struct drsuapi_DsGetDCInfo01 *array;/* [size_is(count),unique] */
};
...
struct drsuapi_DsReplicaGetInfoRequest1 {
	...
	const char *object_dn;/* [string,charset(UTF16),unique] */
	struct GUID guid1;
};

struct drsuapi_DsReplicaGetInfoRequest2 {
	enum drsuapi_DsReplicaInfoType info_type;
	const char *object_dn;/* [string,unique,charset(UTF16)] */
	struct GUID guid1;
	uint32_t unknown1;
	const char *string1;/* [string,charset(UTF16),unique] */
	const char *string2;/* [string,charset(UTF16),unique] */
	uint32_t unknown2;
};
...
struct drsuapi_DsReplicaNeighbour {
	const char *naming_context_dn;/* [charset(UTF16),unique,string] */
	const char *source_dsa_obj_dn;/* [string,unique,charset(UTF16)] */
	const char *source_dsa_address;/* [charset(UTF16),unique,string] */
	const char *transport_obj_dn;/* [charset(UTF16),unique,string] */
	uint32_t replica_flags;
	uint32_t reserved;
...
struct drsuapi_DsReplicaObjMetaData {
	const char *attribute_name;/* [string,charset(UTF16),unique] */
	uint32_t version;
...
struct drsuapi_DsReplicaKccDsaFailure {
	const char *dsa_obj_dn;/* [string,unique,charset(UTF16)] */
...
struct drsuapi_DsReplicaOp {
	...
	const char *nc_dn;/* [unique,charset(UTF16),string] */
	const char *remote_dsa_obj_dn;/* [unique,charset(UTF16),string] */
	const char *remote_dsa_address;/* [charset(UTF16),unique,string] */
...
struct drsuapi_DsReplicaCoursor3 {
	...
	uint64_t highest_usn;
	NTTIME last_sync_success;
	const char *source_dsa_obj_dn;/* [string,charset(UTF16),unique] */
};
...
struct drsuapi_DsReplicaObjMetaData2 {
	const char *attribute_name;/* [string,unique,charset(UTF16)] */
	uint32_t version;
	NTTIME originating_last_changed;
	struct GUID originating_dsa_invocation_id;
	uint64_t originating_usn;
	uint64_t local_usn;
	const char *originating_dsa_obj_dn;/* [string,unique,charset(UTF16)] */
};
...
struct drsuapi_DsReplicaAttrValMetaData2 {
	const char *attribute_name;/* [unique,charset(UTF16),string] */
	const char *object_dn;/* [unique,charset(UTF16),string] */
	uint32_t value_length;
	uint8_t *value;/* [unique,size_is(value_length)] */
	NTTIME deleted;
	NTTIME created;
	...
	uint64_t originating_usn;
	uint64_t local_usn;
	const char *originating_dsa_obj_dn;/* [string,charset(UTF16),unique] */
};
...
struct drsuapi_DsReplica06 {
	const char *str1;/* [charset(UTF16),unique,string] */
	uint32_t u1;
	uint32_t u2;
	uint32_t u3;
	uint32_t u4;
...
union drsuapi_DsReplicaInfo {
	...
	struct drsuapi_DsReplicaCoursorCtr *coursors;/* [case(DRSUAPI_DS_REPLICA_INFO_CURSORS),unique] */
	...
	struct drsuapi_DsReplicaCoursor2Ctr *coursors2;/* [case(DRSUAPI_DS_REPLICA_INFO_CURSORS2),unique] */
	...
	struct drsuapi_DsReplicaNeighbourCtr *neighbours02;/* [case(DRSUAPI_DS_REPLICA_INFO_NEIGHBORS02),unique] */
	...
	struct drsuapi_DsReplica06Ctr *i06;/* [case(DRSUAPI_DS_REPLICA_INFO_06),unique] */
