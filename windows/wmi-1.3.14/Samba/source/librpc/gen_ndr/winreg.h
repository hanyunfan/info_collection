...
struct winreg_EnumValue {
	struct {
		...
		uint8_t *value;/* [unique,size_is(*size),length_is(*length)] */
...
struct winreg_QueryMultipleValues {
	struct {
		...
		struct QueryMultipleValue *values;/* [ref,size_is(num_values),length_is(num_values)] */
		uint32_t num_values;
		uint8_t *buffer;/* [unique,size_is(*buffer_size),length_is(*buffer_size)] */
