...
struct netr_UasInfo {
	const char *account_name;/* [unique,charset(UTF16),string] */
	uint32_t priv;
	uint32_t auth_flags;
	...
	const char *computer;/* [charset(UTF16),unique,string] */
	const char *domain;/* [charset(UTF16),unique,string] */
	const char *script_path;/* [string,charset(UTF16),unique] */
	uint32_t unknown;
};
...
struct netr_ChallengeResponse {
	...
	uint8_t *data;/* [size_is(length),length_is(length),unique] */
...
union netr_Validation {
	struct netr_SamInfo2 *sam2;/* [case(2),unique] */
...
struct netr_DELTA_DELETE_USER {
	const char *account_name;/* [charset(UTF16),unique,string] */
	struct lsa_String unknown1;
	struct lsa_String unknown2;
	struct lsa_String unknown3;
	struct lsa_String unknown4;
...
struct netr_USER_PRIVATE_INFO {
	...
	uint32_t DataLength;
	uint8_t *SensitiveData;/* [unique,size_is(DataLength),flag(LIBNDR_PRINT_ARRAY_HEX)] */
};
...
union netr_DELTA_ID_UNION {
	...
	const char *name;/* [string,case(NETR_DELTA_SECRET),unique,charset(UTF16)] */
}/* [switch_type(netr_DeltaEnum)] */;
...
union netr_CONTROL_DATA_INFORMATION {
	const char *domain;/* [unique,charset(UTF16),case(NETLOGON_CONTROL_REDISCOVER),string] */
	uint32_t debug_level;/* [case(NETLOGON_CONTROL_SET_DBFLAG)] */
};

struct netr_DsRGetDCNameInfo {
	const char *dc_unc;/* [charset(UTF16),unique,string] */
	const char *dc_address;/* [charset(UTF16),unique,string] */
	int32_t dc_address_type;
	struct GUID domain_guid;
	const char *domain_name;/* [charset(UTF16),unique,string] */
	const char *forest_name;/* [charset(UTF16),unique,string] */
	uint32_t dc_flags;
	const char *dc_site_name;/* [string,charset(UTF16),unique] */
	const char *client_site_name;/* [string,charset(UTF16),unique] */
};
...
struct netr_DomainQuery1 {
	...
	const char *workstation_domain;/* [string,unique,charset(UTF16)] */
	const char *workstation_site;/* [string,unique,charset(UTF16)] */
	const char *unknown1;/* [unique,charset(UTF16),string] */
	const char *unknown2;/* [unique,charset(UTF16),string] */
	const char *unknown3;/* [unique,charset(UTF16),string] */
	const char *unknown4;/* [unique,charset(UTF16),string] */
...
struct netr_DomainTrust {
	const char *netbios_name;/* [unique,charset(UTF16),string] */
...
struct netr_LogonUasLogon {
	struct {
		const char *server_name;/* [unique,charset(UTF16),string] */
		const char *account_name;/* [string,charset(UTF16)] */
		const char *workstation;/* [charset(UTF16),string] */
	} in;
...
struct netr_LogonSamLogon {
	struct {
		const char *server_name;/* [unique,charset(UTF16),string] */
		const char *computer_name;/* [string,unique,charset(UTF16)] */
...
struct netr_LogonSamLogoff {
	struct {
		const char *server_name;/* [string,unique,charset(UTF16)] */
		const char *computer_name;/* [string,charset(UTF16),unique] */
		struct netr_Authenticator *credential;/* [unique] */
		struct netr_Authenticator *return_authenticator;/* [unique] */
		uint16_t logon_level;
		union netr_LogonLevel logon;/* [switch_is(logon_level)] */
...
struct netr_ServerAuthenticate {
	struct {
		const char *server_name;/* [string,unique,charset(UTF16)] */
		const char *account_name;/* [charset(UTF16),string] */
...
struct netr_ServerPasswordSet {
	struct {
		...
		const char *account_name;/* [charset(UTF16),string] */
		enum netr_SchannelType secure_channel_type;
		const char *computer_name;/* [charset(UTF16),string] */
...
struct netr_DatabaseDeltas {
	struct {
		const char *logon_server;/* [charset(UTF16),string] */
...
struct netr_DatabaseSync {
	struct {
		const char *logon_server;/* [charset(UTF16),string] */
		const char *computername;/* [charset(UTF16),string] */
		struct netr_Authenticator credential;
		struct netr_Authenticator return_authenticator;
		enum netr_SamDatabaseID database_id;
...
struct netr_AccountDeltas {
	struct {
		const char *logon_server;/* [string,unique,charset(UTF16)] */
		const char *computername;/* [string,charset(UTF16)] */
		struct netr_Authenticator credential;
		struct netr_Authenticator return_authenticator;
...
struct netr_GetDcName {
	struct {
		...
		const char *domainname;/* [unique,charset(UTF16),string] */
	} in;

	struct {
		const char *dcname;/* [string,charset(UTF16),unique] */
		NTSTATUS result;
	} out;
...
struct netr_GetAnyDCName {
	struct {
		const char *logon_server;/* [string,unique,charset(UTF16)] */
		const char *domainname;/* [string,unique,charset(UTF16)] */
	} in;

	struct {
		const char *dcname;/* [unique,charset(UTF16),string] */
		WERROR result;
	} out;
...
struct netr_DatabaseRedo {
	struct {
		...
		struct netr_Authenticator credential;
		struct netr_Authenticator return_authenticator;
		uint8_t *change_log_entry;/* [size_is(change_log_entry_size),unique] */
...
struct netr_DsRGetDCName {
	struct {
		const char *server_unc;/* [string,unique,charset(UTF16)] */
		const char *domain_name;/* [string,unique,charset(UTF16)] */
...
struct netr_DsRGetDCNameEx {
	struct {
		...
		const char *domain_name;/* [charset(UTF16),unique,string] */
		struct GUID *domain_guid;/* [unique] */
		const char *site_name;/* [string,unique,charset(UTF16)] */
		uint32_t flags;
	} in;
...
struct netr_DsRGetSiteName {
	...
	struct {
		const char *site;/* [unique,charset(UTF16),string] */
		WERROR result;
	} out;
...
struct netr_LogonGetDomainInfo {
	struct {
		...
		const char *computer_name;/* [unique,charset(UTF16),string] */
...
struct netr_DsRGetDCNameEx2 {
	struct {
		const char *server_unc;/* [charset(UTF16),unique,string] */
		const char *client_account;/* [string,charset(UTF16),unique] */
		uint32_t mask;
		const char *domain_name;/* [string,unique,charset(UTF16)] */
		struct GUID *domain_guid;/* [unique] */
		const char *site_name;/* [string,unique,charset(UTF16)] */
...
struct netr_LogonSamLogonEx {
	struct {
		const char *server_name;/* [string,unique,charset(UTF16)] */
		const char *computer_name;/* [charset(UTF16),unique,string] */
		uint16_t logon_level;
		union netr_LogonLevel logon;/* [switch_is(logon_level)] */
		uint16_t validation_level;
		uint32_t flags;
...
struct netr_DsrEnumerateDomainTrusts {
	...
	struct {
		uint32_t count;
		struct netr_DomainTrust *trusts;/* [size_is(count),unique] */
		WERROR result;
	} out;
